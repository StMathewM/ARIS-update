        ...
        report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Pakita.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.WRAP_CONTENT);
                 ...
                 a2 = Pakita.findViewById(R.id.radio_animaldeath);
                 a3 = Pakita.findViewById(R.id.radio_animaldeath);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < rprt.length(); i++) {
                        ...
                        name = userdetails.getString("first_name") +" "+userdetails.getString("last_name");
